...
pub async fn run_boot_sequence(state: &AppState) -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
    ...
    info!("Found {} active workflows out of {} total.", active_count, active_workflows.len());

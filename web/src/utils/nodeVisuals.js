import { Settings2, Globe, Database, Bot, Variable, GitBranch, GitMerge, FileCode2, Play, Send, Hash, Github, Table, MessageSquare, Notebook, Table2, DatabaseBackup, Layers, HardDrive, Cloud, Ticket, CreditCard, Mail, CloudLightning, Hexagon, Inbox, Megaphone, Kanban } from 'lucide-vue-next';
export function getNodeVisuals(nodeTypeName) {
    switch (nodeTypeName) {
...
//# sourceMappingURL=nodeVisuals.js.map